...
mydb = mysql.connector.connect(host="localhost", user="soulspy", password="Soulspy@23") 
mycursor = mydb.cursor() 
mycursor.execute("CREATE DATABASE PractDB1") 
...
mydb = mysql.connector.connect(host="localhost", user="soulspy", password="Soulspy@23", database="PractDB1") 
mycursor = mydb.cursor() 
...
myWindow.configure(background = "#0fd5ff"); 
